...
def deduplicate(self, filenames: tuple[str], ignore: tuple[tuple[str, str]] = tuple()) -> tuple[tuple[str]]:
    """
    ...
    Args:
        ...
        ignore (tuple[tuple[str, str]]): A tuple of tuples, where each inner tuple contains
    ...
    """
    try:
        dd = DuplicationDetector(filenames, ignore)
