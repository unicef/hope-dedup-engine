...
CONFIG: "Dict[str, ConfigItem]" = {
    ...
    "AZURE_HOPE_ACCOUNT_NAME": (str, ""),
    "AZURE_HOPE_ACCOUNT_KEY": (str, ""),
    "AZURE_HOPE_CUSTOM_DOMAIN": (str, ""),
    "AZURE_HOPE_CONNECTION_STRING": (str, ""),
    "AZURE_DEDUP_ACCOUNT_NAME": (str, ""),
    "AZURE_DEDUP_ACCOUNT_KEY": (str, ""),
    "AZURE_DEDUP_CUSTOM_DOMAIN": (str, ""),
    "AZURE_DEDUP_CONNECTION_STRING": (str, ""),
