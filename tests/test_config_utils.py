...
@pytest.mark.parametrize(
    ...
    [
        (0, 0, PoolConfig(min_size=1, max_size=1)),
        (0, 1, PoolConfig(min_size=1, max_size=1)),
        (1, 0, PoolConfig(min_size=1, max_size=2)),
        (1, 1, PoolConfig(min_size=1, max_size=3)),
        (2, 2, PoolConfig(min_size=3, max_size=6)),
    ],
)
